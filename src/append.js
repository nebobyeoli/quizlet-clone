...
appendElement('span#progress', 'span',
    {
        class: 'svgwrap',
        style: `padding-right: 1rem;`
    }
...
document.querySelectorAll('div.panel-left > div.panel-list > div > span.float').forEach(el => {
    el.setAttribute('style', `padding-left: 2.35rem;`);
})
